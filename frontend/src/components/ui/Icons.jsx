...
export function BellOffIcon({ size = 20, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...iconProps} className={className}>
      <path d="M13.73 21a2 2 0 0 1-3.46 0" />
      <path d="M18.63 13A17.89 17.89 0 0 0 18 8" />
      <path d="M6 8a6 6 0 0 1 9-5.22" />
      <path d="M22 2L2 22" />
    </svg>
  )
}
...
export function LayoutDashboardIcon({ size = 20, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...iconProps} className={className}>
...
export function SlidersHorizontalIcon({ size = 20, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...iconProps} className={className}>
...
export function BanIcon({ size = 20, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...iconProps} className={className}>
      <circle cx="12" cy="12" r="10" />
...
export function ReplyIcon({ size = 20, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...iconProps} className={className}>
...
export function ForwardIcon({ size = 20, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...iconProps} className={className}>
      <polyline points="15 17 21 12 15 7" />
      <path d="M21 12H9a4 4 0 0 0-4 4v4" />
    </svg>
  )
}
